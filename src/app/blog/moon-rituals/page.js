    ...
    return (
        <>
            ...
            <section className="blog-hero">
                <div className="blog-hero-bg moon" />
                ...
                <div className="blog-hero-content">
                    ...
                    <h1 className="blog-hero-title">Moon Rituals: Harnessing Lunar Cycles for Spiritual Transformation</h1>
                    <p className="blog-hero-desc">The Moon is the cosmic mirror of your inner world. Learn to align with her sacred cycles to manifest, release, and transform every aspect of your being.</p>
                    <div className="blog-hero-meta">
                        <span>Jan 10, 2026</span><span className="meta-dot" /><span>9 min read</span><span className="meta-dot" /><span>Moon Rituals</span>
                    </div>
                </div>
            </section>
